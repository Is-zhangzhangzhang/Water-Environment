...
public class SingleThreadStdoutStderr
{
	...
	{
		String hostname = "100.66.3.211";
		String username = "slave";
		...
		try
		{
			...
			//sess.execCommand("~/mahout/bin/mahout org.apache.mahout.clustering.syntheticcontrol.kmeans.Job");
			out.println("cat /etc/profile");
			out.flush();
			out.close();
			/*
			 * Advanced:
